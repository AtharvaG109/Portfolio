...
export const hero = {
  eyebrow: "Security engineering across offense, detection, AI, and secure systems",
  headline:
    "I engineer systems that are secure by construction, and prove it with replayable runtime evidence.",
  summary:
    "I build the tools and workflows that expose real weaknesses, surface how systems actually behave under load and attack, and turn that evidence into stronger security. The through-line is proof: exploits, traces, packets, logs, tests, and threat models.",
  mission:
