...
export const siteConfig = {
  ...
  availability:
    "Technical identity across backend systems, platform reliability, security automation, observability, AI security, and low-level systems work.",
...
export const hero = {
  eyebrow: "Backend · Platform · Security · Systems Debugging",
  headline:
    "I build backend and security systems where runtime evidence matters.",
  summary:
    "I work across APIs, distributed services, observability, security automation, and low-level debugging. My strongest work connects implementation with proof: traces, packets, logs, tests, threat models, and clear engineering tradeoffs.",
  mission:
  ...
  utilityLinks: [
    { label: "Current focus", value: "Backend systems, security automation, observability, AI security, and low-level systems work", href: "/experience/" },
    ...
    { label: "Contact", value: "Private intake for technical conversations, collaboration, and focused engineering context", href: "/contact/" }
  ]
};
...
export const roleFitCards = [
  {
    ...
    signal: "Evidence shown through ingestion pipelines, OpenTelemetry rollout, uProxy, SecureRAG EvalOps, and reliability-focused backend work."
  },
  {
    title: "Security Engineering",
    body:
      "Security automation, detection logic, AppSec guardrails, IAM workflows, and secure CI/CD controls that engineering teams can maintain.",
    signal: "Evidence shown through LLM RedTeam Framework, Enterprise NIDS, Patchbot, Sysguard, and security monitoring work."
  },
  {
    ...
    signal: "Evidence shown through LLM RedTeam Framework, SecureRAG EvalOps, and agentic workflow security work."
  },
  {
    title: "Systems Debugging and Low-Level Analysis",
    body:
      "Runtime evidence, packet captures, Linux behavior, GDB, memory analysis, compiler work, and root-cause analysis below the surface symptom.",
    signal: "Evidence shown through tinyc, uProxy, Sysguard, SpectreFS, and binary research work."
  }
];
