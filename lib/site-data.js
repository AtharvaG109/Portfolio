...
export const siteConfig = {
  ...
  description:
    "Portfolio of Atharva Gham, a software security engineer working across offensive testing, detection engineering, AI security, and secure system design, backed by deep software engineering.",
  availability:
    "Software security engineer across offensive testing, detection and response, AI security, and secure system design, grounded in real software-engineering depth.",
...
export const hero = {
  eyebrow: "Software Security Engineer · AI Security · Software Engineering",
  headline:
    "I engineer systems that are secure by construction, and prove it with replayable runtime evidence.",
  summary:
    "My work runs across offensive testing, detection engineering, and secure system design: finding the flaws, catching them in production, and building software that stays defensible under real traffic. The common thread is proof: exploits, traces, packets, logs, tests, and threat models.",
  mission:
    "Make software measurably harder to attack and easier to defend once real adversaries and real load show up.",
  focus: [
    "Offensive security: LLM and AI red-teaming, web and binary exploitation, and IAST-style exploit confirmation",
    "Detection and response: network detection, DFIR timeline analysis, runtime monitoring, and SIEM automation",
    "Secure systems: guardrails, IAM, secure CI/CD, encryption, and threat-modeled AI workflows",
    "Software engineering depth: Go, Python, Rust, and C/C++ so the security work stays grounded in real behavior"
  ],
  actions: [
  ...
  utilityLinks: [
    { label: "Current focus", value: "Software security across offense, detection, AI security, and secure system design", href: "/experience/" },
    { label: "Recent work", value: "SpectreFS verification harness, macOS security product work, LLM RedTeam Framework, SecureRAG EvalOps, and Enterprise NIDS", href: "/projects/" },
...
export const stats = [
  ...
  {
    value: "115 / 0",
    label: "Verification checks passing with zero failures in the SpectreFS encrypted vault demo"
  },
  {
    value: "15",
    label: "Shipped security and systems projects across offense, detection, and secure design"
  },
  {
    value: "200+",
    label: "Automated tests gating releases across the flagship security projects"
  }
];
...
export const roleFitCards = [
  ...
  },
  {
    ...
    body:
      "Backend services, compilers, and networking in Go, Python, Rust, and C/C++: the systems fluency that keeps security grounded in real behavior.",
    signal: "Evidence shown through tinyc, uProxy, and production backend and reliability work."
  }
];
...
const projectRecords = [
  ...
  },
  {
    ...
    summary:
      "Built a macOS technical-preview encrypted vault product with a C++20 vault core, SwiftUI app, app-mediated plaintext workflows, and a verification harness proving 115 checks with 0 runtime failures.",
    impact:
      "Turned a local encryption prototype into a proof-driven security product: client-side authenticated encryption, HMAC audit integrity, policy-mediated access, and generated reports that separate working features from planned work.",
    challenge:
    ...
    approach: [
      ...
      "Built `spectrefsctl` and SwiftUI workflows for move-into-vault, restore-to-original-location, export-copy, delete-from-vault, auth lock/status, protected open, health, repair, snapshots, audit verification, and E2EE share demos.",
      "Added a static scanner, runtime demo, tamper demos, auth demo, E2EE demo, memory-safety demo, final report generator, and release packaging docs so the security claims are backed by executable evidence."
    ],
    result:
      "SpectreFS is now a verified technical-preview security product: the latest full demo reports PASS=115, FAIL=0, PARTIAL=0, MISSING=0, and PLANNED=2, while keeping XPC isolation and sender signatures clearly marked as next-phase work.",
    outcomes: [
      ...
      "Generated reports classify implemented-and-working, implemented-but-unproven, missing, failed, skipped/platform-unavailable, and planned-only features for interview-ready review.",
      "The macOS app and CLI mediate plaintext workflows, but the writeup avoids claiming endpoint containment: other apps can see encrypted vault files, and plaintext is only controlled through SpectreFS workflows while materialized."
    ],
    metrics: [
      { value: "115 PASS", label: "Final verification checks" },
      { value: "0 FAIL", label: "Runtime and final report failures" },
      { value: "5 demos", label: "Full, tamper, auth, E2EE, and memory-safety verification" }
    ],
    architecture: [
      "SwiftUI app -> spectrefsctl -> C++20 vault runtime -> OpenSSL-backed crypto provider -> encrypted chunks, with JSON output for app and automation workflows.",
      ...
      "The verification harness produces static, runtime, and final reports that show proof evidence rather than treating documentation as implementation."
    ],
    tradeoffs: [
      ...
      "Left the signed SpectreFSCore.xpc boundary and optional E2EE sender signatures as planned work so the portfolio can show honest judgment instead of overstating the current build."
    ],
...
const projectProofMetadata = {
  ...
  "spectrefs-encrypted-vault-filesystem": {
    displayPriority: 1,
    track: "Secure Systems",
    maturity: "Verified technical-preview security product",
    roleFits: ["Systems Engineering", "Security Product", "macOS"],
    focusTags: ["macOS Security", "Encrypted Vault", "XPC Roadmap", "Endpoint Security Roadmap", "AEAD", "PBAC", "Release Gates"],
    proofBadges: ["115 verification checks", "0 runtime failures", "AEAD chunks", "HMAC audit chain", "SwiftUI macOS app", "E2EE share demo"],
    proofLine:
      "Full security demo proves 115 PASS / 0 FAIL with runtime vault, tamper, auth, E2EE, and memory-safety evidence."
  },
  "event-ingestion-and-observability-pipeline": {
    displayPriority: 14,
    track: "Secure Systems",
...
export const nowSnapshot = {
  ...
  building: [
    "Hardening the LLM RedTeam Framework attack packs and CI reporting toward broader real-target coverage.",
    "Extending SecureRAG EvalOps graph memory and guardrail telemetry for operator-facing deployments.",
    "Maturing the Windows DFIR Timeline Diff Engine past technical preview with wider artifact parsing."
  ],
  studying: [
    "Agentic AI trust boundaries and how tool-using systems fail under adversarial input.",
    "Detection engineering patterns that survive noisy production telemetry.",
    "Low-level runtime behavior: allocators, syscalls, and binary semantics under stress."
  ],
  reading: [
    "Incident writeups and post-mortems for systems under real load.",
    "Exploit-development and reverse-engineering deep dives.",
    "Engineering essays on operability, observability, and secure-by-default design."
  ]
};
